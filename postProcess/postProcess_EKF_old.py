...
if 1:
  ...
  # plot position covariences
  x_lower_bound = position_est[:, 0][select_est][::point_spacing]-np.sqrt(covariance[:, 0][select_est][::point_spacing])*1.96;
  x_upper_bound = position_est[:, 0][select_est][::point_spacing]+np.sqrt(covariance[:, 0][select_est][::point_spacing])*1.96;
  l = axe[0][0].fill_between(time_state_est[select_est][::point_spacing],x_lower_bound,x_upper_bound,alpha=0.3)
  y_lower_bound = position_est[:, 1][select_est][::point_spacing]-np.sqrt(covariance[:, 1][select_est][::point_spacing])*1.96;
  y_upper_bound = position_est[:, 1][select_est][::point_spacing]+np.sqrt(covariance[:, 1][select_est][::point_spacing])*1.96;
  l = axe[0][0].fill_between(time_state_est[select_est][::point_spacing],y_lower_bound,y_upper_bound,alpha=0.3)
  ...
  axe[0][1].legend()
  z_lower_bound = position_est[:, 2][select_est][::point_spacing]-np.sqrt(covariance[:, 2][select_est][::point_spacing])*1.96;
  z_upper_bound = position_est[:, 2][select_est][::point_spacing]+np.sqrt(covariance[:, 2][select_est][::point_spacing])*1.96;
  l = axe[0][1].fill_between(time_state_est[select_est][::point_spacing],z_lower_bound,z_upper_bound,alpha=0.3)
  ...
  axe[1][0].legend()
  x_vel_lower_bound = speed_est[:, 0][select_est][::point_spacing]-np.sqrt(covariance[:, 3][select_est][::point_spacing])*1.96;
  x_vel_upper_bound = speed_est[:, 0][select_est][::point_spacing]+np.sqrt(covariance[:, 3][select_est][::point_spacing])*1.96;
  l = axe[1][0].fill_between(time_state_est[select_est][::point_spacing],x_vel_lower_bound,x_vel_upper_bound,alpha=0.3)
  y_vel_lower_bound = speed_est[:, 1][select_est][::point_spacing]-np.sqrt(covariance[:, 4][select_est][::point_spacing])*1.96;
  y_vel_upper_bound = speed_est[:, 1][select_est][::point_spacing]+np.sqrt(covariance[:, 5][select_est][::point_spacing])*1.96;
  l = axe[1][0].fill_between(time_state_est[select_est][::point_spacing],y_vel_lower_bound,y_vel_upper_bound,alpha=0.3)

  l = axe[1][1].plot(time_state_est[select_est], speed_est[:, 2][select_est], label = "Estimated Z")
  axe[1][1].legend()
  z_vel_lower_bound = speed_est[:, 2][select_est][::point_spacing]-np.sqrt(covariance[:, 5][select_est][::point_spacing])*1.96;
  z_vel_upper_bound = speed_est[:, 2][select_est][::point_spacing]+np.sqrt(covariance[:, 5][select_est][::point_spacing])*1.96;
  l = axe[1][1].fill_between(time_state_est[select_est][::point_spacing],z_vel_lower_bound,z_vel_upper_bound,alpha=0.3)
  ...
  axe[1][2].legend()
  om_x_lower_bound = omega_est[:, 0][select_est][::point_spacing]-np.sqrt(covariance[:, 10][select_est][::point_spacing])*1.96;
  om_x_upper_bound = omega_est[:, 0][select_est][::point_spacing]+np.sqrt(covariance[:, 10][select_est][::point_spacing])*1.96;
  l = axe[1][2].fill_between(time_state_est[select_est][::point_spacing],om_x_lower_bound,om_x_upper_bound,alpha=0.3)
  om_y_lower_bound = omega_est[:, 1][select_est][::point_spacing]-np.sqrt(covariance[:, 11][select_est][::point_spacing])*1.96;
  om_y_upper_bound = omega_est[:, 1][select_est][::point_spacing]+np.sqrt(covariance[:, 11][select_est][::point_spacing])*1.96;
  l = axe[1][2].fill_between(time_state_est[select_est][::point_spacing],om_y_lower_bound,om_y_upper_bound,alpha=0.3)
  ...
  axe[1][3].legend()
  om_z_lower_bound = omega_est[:, 2][select_est][::point_spacing]-np.sqrt(covariance[:, 12][select_est][::point_spacing])*1.96;
  om_z_upper_bound = omega_est[:, 2][select_est][::point_spacing]+np.sqrt(covariance[:, 12][select_est][::point_spacing])*1.96;
  l = axe[1][3].fill_between(time_state_est[select_est][::point_spacing],om_z_lower_bound,om_z_upper_bound,alpha=0.3)
  ...
  axe[2][0].legend()
  m_lower_bound = prop_mass_est[select_est][::point_spacing]-np.sqrt(covariance[:, 13][select_est][::point_spacing])*1.96;
  m_upper_bound = prop_mass_est[select_est][::point_spacing]+np.sqrt(covariance[:, 13][select_est][::point_spacing])*1.96;
  l = axe[2][0].fill_between(time_state_est[select_est][::point_spacing],m_lower_bound,m_upper_bound,alpha=0.3)
